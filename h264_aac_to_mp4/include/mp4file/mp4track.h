...
typedef struct _stMP4Index 
{
	__int64		dwOffset; //wxc 
	DWORD		dwSize;
	FILE*		pFile;
}MP4Index, *LPMp4Index;
//end
...
public:
	...
	void WriteSample( const u_int8_t* pBytes, 
		u_int32_t numBytes,
...
protected:
	...
	u_int64_t	GetSampleFileOffsetEx(MP4SampleId sampleId, int& nChunkLfSampCount);
	...
	void UpdateModificationTimes( MP4Timestamp nTimestamp );
