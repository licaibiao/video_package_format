...
void MP4SetH263Vendor(MP4FileHandle hFile,MP4TrackId trackId,u_int32_t vendor);

void  MP4SetH263DecoderVersion(	MP4FileHandle hFile,MP4TrackId trackId,u_int8_t decoderVersion);

void MP4SetH263Bitrates(MP4FileHandle hFile,MP4TrackId trackId,u_int32_t avgBitrate,u_int32_t maxBitrate);

MP4TrackId MP4AddH263VideoTrack(MP4FileHandle hFile,
		u_int32_t timeScale,
		MP4Duration sampleDuration,
		u_int16_t width,
		u_int16_t height,
...
u_int32_t MP4GetNumberOfTracks(MP4FileHandle hFile, const char* type DEFAULT(NULL),u_int8_t subType DEFAULT(0));
...
u_int16_t MP4FindTrackIndex(MP4FileHandle hFile, MP4TrackId trackId);
...
u_int32_t MP4GetTrackTimeScale(MP4FileHandle hFile, MP4TrackId trackId);

bool MP4SetTrackTimeScale(MP4FileHandle hFile, MP4TrackId trackId, u_int32_t value);

u_int8_t MP4GetTrackAudioMpeg4Type(MP4FileHandle hFile, MP4TrackId trackId);

u_int8_t MP4GetTrackEsdsObjectTypeId(MP4FileHandle hFile, MP4TrackId trackId);
...
u_int32_t MP4GetTrackBitRate(MP4FileHandle hFile, MP4TrackId trackId);

bool MP4GetTrackVideoMetadata(MP4FileHandle hFile,MP4TrackId trackId, uint8_t **ppConfig,uint32_t *pConfigSize);

bool MP4GetTrackESConfiguration(MP4FileHandle hFile, MP4TrackId trackId, u_int8_t** ppConfig, u_int32_t* pConfigSize);

bool MP4SetTrackESConfiguration(MP4FileHandle hFile, MP4TrackId trackId, const u_int8_t* pConfig, u_int32_t configSize);
...
u_int16_t MP4GetTrackVideoWidth(MP4FileHandle hFile, MP4TrackId trackId);

u_int16_t MP4GetTrackVideoHeight(MP4FileHandle hFile, MP4TrackId trackId);

int* MP4GetTrackVideoGop(MP4FileHandle hFile, MP4TrackId trackId);
...
u_int64_t MP4GetTrackIntegerProperty(MP4FileHandle hFile, MP4TrackId trackId, const char* propName);

float MP4GetTrackFloatProperty(	MP4FileHandle hFile, MP4TrackId trackId, const char* propName);

const char* MP4GetTrackStringProperty(MP4FileHandle hFile, MP4TrackId trackId, const char* propName);

void MP4GetTrackBytesProperty(MP4FileHandle hFile, 
	MP4TrackId trackId, 
	const char* propName,
	u_int8_t** ppValue, 
	u_int32_t* pValueSize
...
//new method, add by sb
bool MP4ReadSampleEx(
	/* input parameters */
	MP4FileHandle hFile,
	MP4TrackId trackId, 
	MP4SampleId sampleId,
	u_int32_t SampleCount,        //add by sb, for read spec sample data`
	/* input/output parameters */
	u_int8_t** ppBytes, 
	u_int32_t* pNumBytes,
	u_int32_t* pRealSampleCount = NULL
	);
//////////////////////////////////////////////////////////////////////////
...
u_int32_t MP4GetTrackMaxSampleSize(MP4FileHandle hFile,MP4TrackId trackId); 
