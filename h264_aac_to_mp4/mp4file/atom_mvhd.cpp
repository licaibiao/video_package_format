...
{
	// /* 2 */ 数字代表 参数在该box的参数列表中的index
	if (version == 1) 
	{
		AddProperty( /* 2 */ new MP4Integer64Property("creationTime"));
		AddProperty( /* 3 */ new MP4Integer64Property("modificationTime"));
	}
	else
	{
		AddProperty( /* 2 */ new MP4Integer32Property("creationTime"));
		AddProperty( /* 3 */ new MP4Integer32Property("modificationTime"));
	}

	AddProperty( /* 4 */ new MP4Integer32Property("timeScale"));

	if (version == 1) 
		AddProperty( /* 5 */ new MP4Integer64Property("duration"));
	else 
		AddProperty( /* 5 */ new MP4Integer32Property("duration"));
	...
	AddProperty( /* 9 */ new MP4Integer32Property("nextTrackId"));
}
...
void MP4MvhdAtom::Generate() 
{
	...
	((MP4BytesProperty*)m_pProperties[8])->SetValue(reserved, sizeof(reserved));
